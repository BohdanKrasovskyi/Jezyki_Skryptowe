...
SECRET_KEY = 'django-insecure-q=5npz^7f@liynr52gzu1b(g6z+lv)#+7p%%-e2uzjbv#%9t^*'
...
GOCARDLESS_SECRET_ID = ''   # <-- paste your Secret ID here
GOCARDLESS_SECRET_KEY = ''  # <-- paste your Secret Key here
