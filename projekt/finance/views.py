...
from .banking_api import GoCardlessError, GoCardlessNetworkError
from .forms import (
...
def transaction_list(request):
    ...
    transactions = tx_repo.filter(**filters)
...
def banking_unlink(request, pk):
    ...
    try:
        ...
        pass  # best-effort remote cleanup; local record is always deleted
    linked.delete()
